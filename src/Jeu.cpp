...
int Jeu::nbEnnemis()
{
    ...
    {
        if (gpEnnemi2->getVie() > 0 && gpEnnemi2->getX() > gpMonde->regionValue(0) && gpEnnemi2->getX() < gpMonde->regionValue(2) && gpEnnemi2->getY() > gpMonde->regionValue(1) && gpEnnemi2->getY() < gpMonde->regionValue(3))
            t++;
...
void Jeu::lire()
{
    ...
    if (gpMonde->murValue(i, j) && val == 303 && gpJoueur->getDirection() == N)
    {
        ...
        case C_QUART_COEUR:
            ...
            if (id == C_RIEN)
            {
                gpPnj->getSuivant()->setMessage(153);
                ecrit(157);
            }
            if (id == C_QUART_COEUR)
            {
...
bool Jeu::finTexte(int id)
{
    ...
    case 38:
        ...
        gpPnj->getSuivant()->setMessage(39);
        break;
    case 67:
        gpJoueur->setCle(zone - 12, 0);
        break;
    case 68:
        gpJoueur->setCle(zone - 12, 1);
        break;
    case 69:
        gpJoueur->setCle(zone - 12, 2);
        break;
    case 70:
        ...
        case 18:
            if (gpMonde->regionValue(0) == 60 * 16)
                gpJoueur->setCoffre(7, 0);
            if (gpMonde->regionValue(0) == 120 * 16)
                gpJoueur->setCoffre(7, 1);
            break;
        case 19:
            if (gpMonde->regionValue(0) == 60 * 16)
                gpJoueur->setCoffre(8, 0);
            if (gpMonde->regionValue(0) == 0)
                gpJoueur->setCoffre(8, 1);
            break;
        case 20:
            if (gpMonde->regionValue(0) == 20 * 16)
                gpJoueur->setCoffre(9, 0);
            if (gpMonde->regionValue(0) == 0)
    ...
    case 87:
        ...
        gpPnj->getSuivant()->setTypeIA(IA_SUIT);
        break;
    case 90:
        ...
        break;
    case 92:
        gpJoueur->setBoostVie(gpJoueur->getVieMax() - gpJoueur->getVie());
        break;
    case 97:
    ...
    case 102:
        ...
        gpJoueur->trouveMedaillon(zone - 24);
        break;
    case 103:
        trouve(C_MIMAGIE);
        return true;
    ...
    case 129: // ach�te objet
        ...
        case 114:
            ...
            obj = new Objet(this, 0, 0, I_PETIT_COEUR);
            break;
        case 116:
            gpJoueur->setBoostRubis(-20);
            obj = new Objet(this, 0, 0, I_MAGIE_PEU);
            break;
        case 118:
            gpJoueur->setBoostRubis(-30);
            obj = new Objet(this, 0, 0, I_MAGIE_BCP);
            break;
        case 120:
            gpJoueur->setBoostRubis(-30);
            obj = new Objet(this, 0, 0, I_FLECHE);
            break;
        case 122:
            gpJoueur->setBoostRubis(-30);
            obj = new Objet(this, 0, 0, I_BOMBE);
            break;
        case 126:
            gpJoueur->setBoostRubis(-50);
            gpMonde->setContenu(gpJoueur->getX() + 8, gpJoueur->getY() + 7 - 2, 0);
            gpObjet->getSuivant()->ramasse();
            return true;
            break;
        default:
            return false;
    ...
    case 153:
        ...
        gpJoueur->setBoostRubis(-10);
        gpPnj->getSuivant()->setMessage(155);
        ecrit(129);
        return true;
        break;
    case 166:
    ...
    case 179:
        ...
        gpPnj->getSuivant()->setMessage(181);
        break;
    case 195:
        gpJoueur->trouveObjet(O_ENCYCL);
        gpPnj->getSuivant()->setMessage(196);
        break;
    case 203:
        int id;
        id = 38;
        while (gpJoueur->getCoeur(id))
        {
            id++;
            if (id > 43)
                return false;
        }
        gpJoueur->setCoeur(id);
...
bool Jeu::coupeRideau(int i, int j)
{
    ...
    {
        if (gpMonde->motifValue(i - 16, j) != 2276)
            gpMonde->passage(i / 16, (j / 16) - 1, 0);
        else
            gpMonde->passage((i / 16) - 1, (j / 16) - 1, 0);
        return true;
    }
    return false;
}
...
bool Jeu::exploseMur(int i, int j)
{
    ...
    if (val == 532 || val == 533 || val == 790 || val == 791)
    {
        ...
        if (zone == 1)
            gpJoueur->setCoffre(0, 0);
        if (zone == 3)
            gpJoueur->setCoffre(0, 1);
        if (zone == 3 && (val == 790 || val == 791))
    ...
    // g et d
    if (val == 1099 || val == 1101 || val == 1102 || val == 1104 || val == 1457 || val == 1459 || val == 1460 || val == 1462 || val == 2388 || val == 2390 || val == 2391 || val == 2393)
    {
        if (zone == 12)
            gpJoueur->setCoffre(1, 7);
        if (zone == 14 && gpMonde->regionValue(1) == 105 * 16)
    ...
    if (val == 1894)
    {
        ...
        x1 = ((int)(i / 16));
        y1 = ((int)(j / 16));
        while (gpMonde->motifValue((x1 - 1) * 16, y1 * 16) == 1894)
            x1--;
        while (gpMonde->motifValue(x1 * 16, (y1 - 1) * 16) == 1894)
            y1--;
...
void Jeu::donneObjet(Ennemi *ennemi)
{
    ...
    // sp�cial
    if (zone == 20 && gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 30 * 16 && gpJoueur->getCoffre(9, 9) == 0)
        obj = I_PETITE_CLE;
...
void Jeu::ouvrePorteDonjon(int x, int y)
{
    ...
    if ((val == 1170 || val == 1171 || val == 1303 || val == 1304 || val == 1445 || val == 1446 || val == 1591 || val == 1592 || val == 1708 || val == 1709 || val == 1868 || val == 1869 || val == 1987 || val == 1988 || val == 2133 || val == 2134 || val == 2265 || val == 2266) && gpJoueur->getCle(zone - 12, 2) > 0)
    {
        if (zone == 12)
    ...
    if ((val == 1132 || val == 1133 || val == 1134 || val == 1135 || val == 1265 || val == 1266 || val == 1267 || val == 1268 || val == 1425 || val == 1426 || val == 1427 || val == 1428 || val == 1571 || val == 1572 || val == 1573 || val == 1574 || val == 1959 || val == 1960 || val == 1961 || val == 1962 || val == 2093 || val == 2094 || val == 2095 || val == 2096 || val == 2225 || val == 2226 || val == 2227 || val == 2228) && gpJoueur->getCle(zone - 12, 3) > 0)
    {
        if (zone == 12)
            gpJoueur->setCoffre(1, 3);
        if (zone == 13 && gpMonde->regionValue(0) == 20 * 16)
            gpJoueur->setCoffre(2, 1);
        if (zone == 13 && gpMonde->regionValue(0) == 80 * 16)
            gpJoueur->setCoffre(2, 3);
        if (zone == 13 && gpMonde->regionValue(0) == 40 * 16)
            gpJoueur->setCoffre(2, 4);
        if (zone == 14 && gpMonde->regionValue(0) == 40 * 16)
            gpJoueur->setCoffre(3, 5);
        if (zone == 14 && gpMonde->regionValue(0) == 60 * 16)
            gpJoueur->setCoffre(3, 6);
        if (zone == 14 && gpMonde->regionValue(0) == 260 * 16)
            gpJoueur->setCoffre(3, 7);
        if (zone == 15 && gpMonde->regionValue(0) == 160 * 16)
            gpJoueur->setCoffre(4, 4);
        if (zone == 15 && gpMonde->regionValue(0) == 140 * 16)
            gpJoueur->setCoffre(4, 5);
        if (zone == 18 && gpMonde->regionValue(0) == 80 * 16)
            gpJoueur->setCoffre(7, 2);
        if (zone == 18 && gpMonde->regionValue(0) == 100 * 16)
    ...
    if ((val == 1141 || val == 1146 || val == 1274 || val == 1279 || val == 1434 || val == 1439 || val == 1580 || val == 1585 || val == 1689 || val == 1694 || val == 1837 || val == 1842 || val == 2102 || val == 2107 || val == 2234 || val == 2239 || val == 2350 || val == 2355) && gpJoueur->getCle(zone - 12, 3) > 0)
    {
        if (zone == 12 && gpJoueur->getY() > 40 * 16)
            gpJoueur->setCoffre(1, 4);
        if (zone == 12 && gpJoueur->getY() < 40 * 16)
            gpJoueur->setCoffre(1, 5);
        if (zone == 13 && gpMonde->regionValue(3) == 45 * 16)
            gpJoueur->setCoffre(2, 0);
        if (zone == 13 && gpMonde->regionValue(3) == 90 * 16)
        ...
        if (zone == 16)
            gpJoueur->setCoffre(5, 1);
        if (zone == 17 && gpMonde->regionValue(0) == 80 * 16)
            gpJoueur->setCoffre(6, 3);
        if (zone == 17 && gpMonde->regionValue(0) == 100 * 16)
            gpJoueur->setCoffre(6, 4);
        if (zone == 17 && gpMonde->regionValue(0) == 60 * 16)
            gpJoueur->setCoffre(6, 5);
        if (zone == 19)
            gpJoueur->setCoffre(8, 3);
        if (zone == 20 && gpMonde->regionValue(0) < 100 * 16)
...
bool Jeu::isDangereux(int x, int y)
{
    if (gpJoueur->getInvincible() || !gpJoueur->getVie())
        return false;
    // motif dangereux
    if (gpMonde->motifValue(x, y) == 830 || gpMonde->motifValue(x + 15, y) == 830 || gpMonde->motifValue(x, y + 15) == 830 || gpMonde->motifValue(x + 15, y + 15) == 830 || gpMonde->motifValue(x, y) == 1892 || gpMonde->motifValue(x + 15, y) == 1892 || gpMonde->motifValue(x, y + 15) == 1892 || gpMonde->motifValue(x + 15, y + 15) == 1892)
    {
...
{
    int val = gpMonde->motifValue(x, y);
    if (val >= 38 && val <= 39 && g == 2)
        return true;
    if (val >= 30 && val <= 37 && g >= 1)
        return true;
    return false;
}
...
int Jeu::enleve()
{
    ...
    if (isDonjon())
    {
        if (gpMonde->contenuValue(i, j) == 51)
            gpMonde->setValeur(i, j, 1760, -1, 0, 51);
        if (gpMonde->contenuValue(i, j) == 50)
            gpMonde->setValeur(i, j, 1759, -1, 0, 50);
    }
...
void Jeu::testAnim()
{
    ...
    {
    case 12:
        if (gpMonde->regionValue(0) == 110 * 16 && gpJoueur->hasCristal(0) && gpMonde->motifValue(119 * 16, 13 * 16) == 1188)
        {
            gpAudio->playSound(20);
            gpMonde->passage(119, 15, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 110 * 16 && !gpJoueur->hasCristal(0) && gpMonde->motifValue(119 * 16, 13 * 16) == 1071)
        {
            gpAudio->playSound(20);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(119 * 2 + i, 13 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(119 * 2 + i, 13 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(119 * 2 + i, 13 * 2 + 3, SEMI_PLEIN);
        }
        break;
    case 13:
        if (gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 60 * 16 && gpJoueur->hasCristal(1) && gpMonde->motifValue(69 * 16, 73 * 16) == 1349)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 75, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 60 * 16 && !gpJoueur->hasCristal(1) && gpMonde->motifValue(69 * 16, 73 * 16) == 1244)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(69 * 2 + i, 73 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(69 * 2 + i, 73 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(69 * 2 + i, 73 * 2 + 3, SEMI_PLEIN);
        }
        break;
    case 14:
        if (gpMonde->regionValue(0) == 80 * 16 && gpMonde->regionValue(1) == 90 * 16 && gpJoueur->hasCristal(2) && gpMonde->motifValue(89 * 16, 103 * 16) == 1451)
        {
            gpAudio->playSound(20);
            gpMonde->passage(89, 105, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 80 * 16 && gpMonde->regionValue(1) == 90 * 16 && !gpJoueur->hasCristal(2) && gpMonde->motifValue(89 * 16, 103 * 16) == 1403)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(89 * 2 + i, 103 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(89 * 2 + i, 103 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(89 * 2 + i, 103 * 2 + 3, SEMI_PLEIN);
        }
        if (gpMonde->motifValue(67 * 16, 41 * 16) == 1181 && gpMonde->motifValue(72 * 16, 41 * 16) == 1181 && gpMonde->motifValue(69 * 16, 45 * 16) == 1447)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 45, 0);
        }
        if (gpMonde->motifValue(87 * 16, 48 * 16) == 1181 && gpMonde->motifValue(92 * 16, 48 * 16) == 1181 && gpMonde->motifValue(89 * 16, 45 * 16) == 1447)
        {
            gpAudio->playSound(20);
            gpMonde->passage(89, 45, 0);
        }
        if (gpMonde->motifValue(307 * 16, 108 * 16) == 1181 && gpMonde->motifValue(312 * 16, 108 * 16) == 1181 && gpMonde->motifValue(309 * 16, 105 * 16) == 1447)
        {
            gpAudio->playSound(20);
            gpMonde->passage(309, 105, 0);
        }
        if (gpMonde->motifValue(227 * 16, 33 * 16) == 1181 && gpMonde->motifValue(232 * 16, 33 * 16) == 1181 && gpMonde->motifValue(223 * 16, 41 * 16) == 1181 && gpMonde->motifValue(236 * 16, 41 * 16) == 1181 && gpMonde->motifValue(229 * 16, 30 * 16) == 1447)
        {
            gpAudio->playSound(20);
        ...
        break;
    case 15:
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 30 * 16 && gpJoueur->hasCristal(3) && gpMonde->motifValue(49 * 16, 43 * 16) == 1597)
        {
            gpAudio->playSound(20);
            gpMonde->passage(49, 45, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 30 * 16 && !gpJoueur->hasCristal(3) && gpMonde->motifValue(49 * 16, 43 * 16) == 1549)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(49 * 2 + i, 43 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(49 * 2 + i, 43 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(49 * 2 + i, 43 * 2 + 3, SEMI_PLEIN);
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(20 * 16, 66 * 16) == 1601)
        {
            gpAudio->playSound(20);
            gpMonde->passage(20, 66, 1);
        }
        if (gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(80 * 16, 66 * 16) == 1601)
        {
            gpAudio->playSound(20);
            gpMonde->passage(80, 66, 1);
        }
        if (gpMonde->regionValue(0) <= 20 * 16 && gpMonde->regionValue(1) == 45 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(20 * 16, 51 * 16) == 1601)
        {
            gpAudio->playSound(20);
            gpMonde->passage(20, 51, 1);
        }
        if (gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 45 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(140 * 16, 51 * 16) == 1601)
        {
            gpAudio->playSound(20);
            gpMonde->passage(140, 51, 1);
        }
        if (gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 15 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(140 * 16, 21 * 16) == 1601)
        {
            gpAudio->playSound(20);
            gpMonde->passage(140, 21, 1);
        }
        if (gpMonde->regionValue(0) == 80 * 16 && gpMonde->regionValue(1) == 15 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(89 * 16, 15 * 16) == 1593)
        {
            gpAudio->playSound(20);
            gpMonde->passage(89, 15, 0);
        }
        if (gpMonde->regionValue(0) == 160 * 16 && gpMonde->regionValue(1) == 30 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(169 * 16, 30 * 16) == 1593)
        {
            gpAudio->playSound(20);
        ...
        break;
    case 16:
        if (gpMonde->regionValue(0) == 160 * 16 && gpMonde->regionValue(1) == 45 * 16 && gpJoueur->hasCristal(4) && gpMonde->motifValue(169 * 16, 58 * 16) == 1718)
        {
            gpAudio->playSound(20);
            gpMonde->passage(169, 60, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 160 * 16 && gpMonde->regionValue(1) == 45 * 16 && !gpJoueur->hasCristal(4) && gpMonde->motifValue(169 * 16, 58 * 16) == 1668)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(169 * 2 + i, 58 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(169 * 2 + i, 58 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(169 * 2 + i, 58 * 2 + 3, SEMI_PLEIN);
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 0 && nbEnnemis() == 0 && gpMonde->motifValue(40 * 16, 6 * 16) == 1722)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 6, 1);
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 0 && nbEnnemis() == 0 && gpMonde->motifValue(40 * 16, 6 * 16) == 1722)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 6, 1);
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(40 * 16, 66 * 16) == 1722)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 66, 1);
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(40 * 16, 66 * 16) == 1722)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 66, 1);
        }
        if (gpMonde->regionValue(0) == 160 * 16 && gpMonde->regionValue(1) == 30 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(169 * 16, 30 * 16) == 1714)
        {
            gpAudio->playSound(20);
            gpMonde->passage(169, 30, 0);
        }
        break;
    case 17:
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 0 && gpJoueur->hasCristal(5) && gpMonde->motifValue(29 * 16, 13 * 16) == 1850)
        {
            gpAudio->playSound(20);
            gpMonde->passage(29, 15, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 0 && !gpJoueur->hasCristal(5) && gpMonde->motifValue(29 * 16, 13 * 16) == 1808)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(29 * 2 + i, 13 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(29 * 2 + i, 13 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(29 * 2 + i, 13 * 2 + 3, SEMI_PLEIN);
        }
        if (gpMonde->motifValue(102 * 16, 107 * 16) == 1181 && gpMonde->motifValue(137 * 16, 107 * 16) == 1181 && gpMonde->motifValue(102 * 16, 132 * 16) == 1181 && gpMonde->motifValue(137 * 16, 132 * 16) == 1181 && gpMonde->motifValue(100 * 16, 126 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(100, 126, 1);
        }
        if (gpMonde->motifValue(19 * 16, 119 * 16) == 1181 && gpMonde->motifValue(40 * 16, 126 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 126, 1);
        }
        if (gpMonde->motifValue(77 * 16, 17 * 16) == 1181 && gpMonde->motifValue(62 * 16, 27 * 16) == 1181 && gpMonde->motifValue(77 * 16, 27 * 16) == 1181 && gpMonde->motifValue(69 * 16, 15 * 16) == 1846)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 15, 0);
        }
        if (gpMonde->motifValue(62 * 16, 32 * 16) == 1181 && gpMonde->motifValue(77 * 16, 32 * 16) == 1181 && gpMonde->motifValue(62 * 16, 42 * 16) == 1181 && gpMonde->motifValue(77 * 16, 42 * 16) == 1181 && gpMonde->motifValue(69 * 16, 30 * 16) == 1846)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 30, 0);
        }
        if (gpMonde->motifValue(68 * 16, 62 * 16) == 1181 && gpMonde->motifValue(71 * 16, 62 * 16) == 1181 && gpMonde->motifValue(69 * 16, 60 * 16) == 1846)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 60, 0);
        }
        if (gpMonde->motifValue(63 * 16, 52 * 16) == 1181 && gpMonde->motifValue(76 * 16, 52 * 16) == 1181 && gpMonde->motifValue(69 * 16, 45 * 16) == 1846)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 45, 0);
        }
        if (gpMonde->motifValue(68 * 16, 137 * 16) == 1181 && gpMonde->motifValue(71 * 16, 137 * 16) == 1181 && gpMonde->motifValue(69 * 16, 135 * 16) == 1846)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 135, 0);
        }
        if (gpMonde->motifValue(62 * 16, 125 * 16) == 1181 && gpMonde->motifValue(62 * 16, 129 * 16) == 1181 && gpMonde->motifValue(60 * 16, 126 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(60, 126, 1);
        }
        if (gpMonde->motifValue(77 * 16, 125 * 16) == 1181 && gpMonde->motifValue(77 * 16, 129 * 16) == 1181 && gpMonde->motifValue(80 * 16, 126 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(80, 126, 1);
        }
        if (gpMonde->motifValue(69 * 16, 97 * 16) == 1181 && gpMonde->motifValue(70 * 16, 97 * 16) == 1181 && gpMonde->motifValue(60 * 16, 96 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(60, 96, 1);
            gpMonde->passage(80, 96, 1);
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 135 * 16 && nbEnnemis() <= 1 && gpMonde->motifValue(40 * 16, 141 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(40, 141, 1);
        }
        if (gpMonde->regionValue(0) == 80 * 16 && gpMonde->regionValue(1) == 135 * 16 && nbEnnemis() <= 1 && gpMonde->motifValue(100 * 16, 141 * 16) == 1854)
        {
            gpAudio->playSound(20);
            gpMonde->passage(100, 141, 1);
        }
        if (gpMonde->regionValue(0) == 320 * 3 && gpMonde->regionValue(1) == 240 * 7 && gpMonde->motifValue(68 * 16, 137 * 16) != 1181)
        {
            gpMonde->passage(69, 135, 0);
        ...
        break;
    case 18:
        if (gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 15 * 16 && gpJoueur->hasCristal(6) && gpMonde->motifValue(149 * 16, 28 * 16) == 1969)
        {
            gpAudio->playSound(20);
            gpMonde->passage(149, 30, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 15 * 16 && !gpJoueur->hasCristal(6) && gpMonde->motifValue(149 * 16, 28 * 16) == 1939)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 1, PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 2, HAUT);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 3, SEMI_PLEIN);
        }
        if (gpMonde->motifValue(17 * 16, 65 * 16) == 1455 && gpMonde->motifValue(17 * 16, 69 * 16) == 1455 && gpMonde->motifValue(20 * 16, 66 * 16) == 1973)
        {
            gpAudio->playSound(20);
            gpMonde->passage(20, 66, 1);
        }
        if (gpMonde->motifValue(182 * 16, 65 * 16) == 1455 && gpMonde->motifValue(182 * 16, 69 * 16) == 1455 && gpMonde->motifValue(180 * 16, 66 * 16) == 1973)
        {
            gpAudio->playSound(20);
            gpMonde->passage(180, 66, 1);
        }
        if (gpMonde->motifValue(188 * 16, 62 * 16) == 1455 && gpMonde->motifValue(191 * 16, 62 * 16) == 1455 && gpMonde->motifValue(189 * 16, 60 * 16) == 1965)
        {
            gpAudio->playSound(20);
            gpMonde->passage(189, 60, 0);
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(29 * 16, 60 * 16) == 1965)
        {
            gpAudio->playSound(20);
            gpMonde->passage(29, 60, 0);
        }
        if (gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 60 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(80 * 16, 66 * 16) == 1973)
        {
            gpAudio->playSound(20);
            gpMonde->passage(80, 66, 1);
        }
        break;
    case 19:
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 45 * 16 && !nbEnnemis() && gpMonde->motifValue(29 * 16, 43 * 16) == 2115)
        {
            gpAudio->playSound(20);
            gpMonde->passage(29, 45, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 45 * 16 && gpJoueur->getEpee() == 5 && gpMonde->motifValue(29 * 16, 58 * 16) == 2115)
        {
            gpAudio->playSound(20);
            gpMonde->passage(29, 60, 0);
            break;
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 45 * 16 && nbEnnemis() && gpMonde->motifValue(29 * 16, 58 * 16) == 2071)
        {
            gpAudio->playSound(20);
            gpAudio->playSpecial(1);
            gpStatut->setJauge(true);
        ...
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 135 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(49 * 16, 135 * 16) == 2111)
        {
            gpAudio->playSound(20);
            gpMonde->passage(49, 135, 0);
        }
        if (gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 90 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(9 * 16, 105 * 16) == 2111)
        {
            gpAudio->playSound(20);
            gpMonde->passage(9, 105, 0);
        }
        if (gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 105 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(69 * 16, 105 * 16) == 2111)
        {
            gpAudio->playSound(20);
            gpMonde->passage(69, 105, 0);
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 15 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(49 * 16, 15 * 16) == 2111)
        {
            gpAudio->playSound(20);
            gpMonde->passage(49, 15, 0);
        }
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 105 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(60 * 16, 111 * 16) == 2119)
        {
            gpAudio->playSound(20);
        ...
        break;
    case 20:
        if (gpMonde->regionValue(0) == 40 * 16 && gpMonde->regionValue(1) == 75 * 16 && gpMonde->motifValue(49 * 16, 88 * 16) == 2203)
        {
            gpAudio->playSound(20);
        ...
        if (gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 15 * 16 && gpMonde->motifValue(149 * 16, 28 * 16) == 2327 && gpJoueur->getCle(8, 3) > 0)
        {
            gpAudio->playSound(20);
            gpJoueur->moveY(-16);
            ...
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 3, SEMI_PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 4, SEMI_PLEIN);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 5, BAS);
            for (int i = 0; i < 4; i++)
                gpMonde->setMurs(149 * 2 + i, 28 * 2 + 6, PLEIN);
        }
        if (gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 15 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(9 * 16, 15 * 16) == 2243)
        {
            gpAudio->playSound(20);
            gpMonde->passage(9, 15, 0);
        }
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 15 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(29 * 16, 15 * 16) == 2243)
        {
            gpAudio->playSound(20);
            gpMonde->passage(29, 15, 0);
        }
        if (gpMonde->regionValue(0) == 120 * 16 && gpMonde->regionValue(1) == 30 * 16 && nbEnnemis() == 0 && gpMonde->motifValue(129 * 16, 30 * 16) == 2359)
        {
            gpAudio->playSound(20);
            gpMonde->passage(129, 30, 0);
        }
        if (gpMonde->regionValue(0) == 160 * 16 && gpMonde->regionValue(1) == 90 * 16 && gpJoueur->getCle(8, 2) && gpMonde->motifValue(160 * 16, 96 * 16) == 2367)
        {
            gpAudio->playSound(20);
            gpMonde->passage(160, 96, 1);
        }
        if (gpMonde->regionValue(0) == 320 * 2 && gpMonde->regionValue(1) == 0 && gpMonde->motifValue(49 * 16, 16 * 16) == 2276)
        {
            gpMonde->passage(49, 15, 0);
        }
        break;
    case 23:
        if (gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 0 && gpMonde->motifValue(19 * 16, 6 * 16) == 1861)
        {
            gpAudio->playSound(20);
            gpMonde->passage(20, 6, 1);
        }
        if (gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 0 && gpMonde->motifValue(18 * 16, 6 * 16) != 1860)
        {
            gpAudio->playSound(20);
            gpJoueur->moveX(-16);
            ...
            for (int i = 0; i < 6; i++)
                gpMonde->setMurs(18 * 2 + 1, 6 * 2 + i, PLEIN);
            for (int i = 0; i < 6; i++)
                gpMonde->setMurs(18 * 2 + 2, 6 * 2 + i, GAUCHE);
            for (int i = 0; i < 6; i++)
                gpMonde->setMurs(18 * 2 + 3, 6 * 2 + i, SEMI_PLEIN);
        }
        break;
    }
}
...
void Jeu::finZone()
{
    ...
    if (zone != newzone)
    {
        ...
        if (isDonjon() && !gpJoueur->getCharge() && (gpMonde->regionValue(1) || zone != 20))
            gpJoueur->setDirection(N);
        if (zone == 4 && newx == 16 * 42 && newy == 16 * 5 - 8)
            gpJoueur->setDirection(E);
...
void Jeu::testFin()
{
    ...
    case 9:
        ...
        if ((((int)(gpJoueur->getX() / 16)) == 64 || ((int)(gpJoueur->getX() / 16)) == 65) && ((int)(gpJoueur->getY() / 16)) == 24)
            gpMonde->transitFull(20, 792, 920);
        if ((((int)(gpJoueur->getX() / 16)) == 64 || ((int)(gpJoueur->getX() / 16)) == 65) && ((int)(gpJoueur->getY() / 16)) == 19)
        ...
        if (((int)(gpJoueur->getX() / 16)) >= 62 &&
            ((int)(gpJoueur->getX() / 16)) <= 66 && ((int)(gpJoueur->getY() / 16)) == 31 && (gpJoueur->nbCristaux() < 7))
        { // entre chateau sans cristaux
            gpAudio->playSound(5);
            SDL_Delay(1500);
    ...
    case 11:
        ...
        break;
    case 12:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 20 * 16 && gpMonde->regionValue(1) == 60 * 16)
            gpMonde->transitFull(1, 16 * 49 + 8, 16 * 21 - 8);
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 60 * 16)
        ...
        break;
    case 13:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 60 * 16 && gpMonde->regionValue(1) == 75 * 16)
            gpMonde->transitFull(3, 16 * 88 + 8, 16 * 37 - 8);
        break;
    case 14:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 80 * 16 && gpMonde->regionValue(1) == 105 * 16)
            gpMonde->transitFull(4, 16 * 27, 16 * 3 - 8);
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 100 * 16 && gpMonde->regionValue(1) == 105 * 16)
    ...
    case 15:
        ...
        break;
    case 16:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 0)
            gpMonde->transitFull(1, 16 * 49 + 8, 16 * 6 - 8);
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 0 && gpMonde->regionValue(1) == 75 * 16)
        ...
        break;
    case 17:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 && gpMonde->regionValue(1) == 240)
            gpMonde->transitFull(7, 16 * 35 + 8, 16 * 30 - 8);
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 * 3 && gpMonde->regionValue(1) == 240 * 9)
    ...
    case 18:
        ...
        break;
    case 19:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 && gpMonde->regionValue(1) == 240 * 9)
            gpMonde->transitFull(11, 16 * 145, 16 * 4);
        break;
    case 20:
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 && gpMonde->regionValue(1) == 240 * 3)
        {
            if (gpJoueur->getAvancement() == 5 || gpJoueur->getAvancement() == 6)
            {
                ...
                gpMonde->transitFull(9, 16 * 64 + 8, 16 * 26 + 8);
        }
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 * 2 && gpMonde->regionValue(1) == 240 * 6)
            gpMonde->transitFull(9, 16 * 64 + 8, 16 * 21 + 8);
        if (gpJoueur->getX() > 16 * 159 - 8 && gpMonde->regionValue(0) == 140 * 16 && gpMonde->regionValue(1) == 15 * 16 && gpJoueur->getAvancement() < 5)
        { // oublie zelda
            ecrit(95);
            gpJoueur->moveX(-4);
            gpJoueur->setDirection(O);
        ...
        break;
    case 21:
        if (gpJoueur->getY() > 240 - 24 - 4)
            gpMonde->transitFull(1, 472, 584);
        break;
    case 22:
        ...
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 * 2 && gpMonde->regionValue(1) == 240)
    ...
    case 23:
        ...
        if (gpJoueur->getY() > gpMonde->regionValue(3) - 28 && gpMonde->regionValue(0) == 320 * 3 && gpMonde->regionValue(1) == 240 * 4)
