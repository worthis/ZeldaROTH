...
void Texte::chercheText()
{
    ...
    case 21:
        ...
        break;
    case 22:
        texte = "В: Деревня Теней*- Не место для живых -";
        break;
    case 23:
        texte = "Темный Храм**Если ты призрак, ищущий работу, то тебе стоит зайти и потусить с нами.";
        break;
    case 24:
    ...
    case 36:
        ...
        break;
    case 37:
        texte = "Сначала раздобудь разрешение Старосты, если хочешь пройти здесь!!!";
        break;
    case 38:
    ...
    case 47:
        ...
        break;
    case 48:
        texte = "Зачем я только согласилась ухаживать за этим гадюшником???*Терпеть не могу кур!!!";
        break;
    case 49:
    ...
    case 51:
        ...
        break;
    case 52:
        texte = "Заблудились в пустыне?*Вы здесь:*                        X";
        break;
    case 54:
        texte = "Ю: К Замку Хайрула";
        break;
    case 55:
    ...
    case 57:
        ...
        break;
    case 58:
        texte = "Ледяной Храм**Персонал напоминает вам, что это подземелье, а не каток.";
        break;
    case 59:
        texte = "Вы еще не были у нашего кузнеца?*Говорят, у него огромное мастерство улучшать разнообразное снаряжение искателей приключений.*У него очень много клиентов.";
        break;
    case 60:
        texte = "Храм находится в самой глубине пустыни, у древнего оазиса.";
        break;
    case 61:
    ...
    case 68:
        ...
        break;
    case 69:
        texte = "Ты нашел Ключ Босса!!!*Теперь ты можешь войти в его логово.";
        break;
    case 70:
    ...
    case 72:
        ...
        if (tmp == 6 && !gpJeu->getJoueur()->getAvancement())
            buffer = "Интересно, для чего он нужен...?";
        else if (tmp > 2)
    ...
    case 80:
        ...
        break;
    case 81:
        texte = "Ты нашел Лампу!!!*Используй ее, чтобы испускать огонь.";
        break;
    case 82:
    ...
    case 90:
        ...
        break;
    case 91:
        texte = "Боюсь, что с твоим нынешним оружием ты не сможешь победить Ганона...*Поговори со старостой деревни Какарико, я уверена, он что-нибудь придумает.";
        break;
    case 92:
        texte = "Ганон прямо за этой дверью, давай я исцелю твои раны.";
        break;
    case 93:
    ...
    case 111:
        ...
        break;
    case 112:
        texte = "Здравствуйте!*Вы хотели бы что-нибудь выпить?";
        break;
    case 113:
    ...
    case 119:
        ...
        break;
    case 120:
        texte = "Пять стрел за 30 рупий, возьмете?**          ? ДА ?           нет  ";
    ...
    case 125:
        ...
        break;
    case 126:
        texte = "Лук за 50 рупий, возьмете?**          ? ДА ?           нет  ";
    ...
    case 130:
        ...
        break;
    case 131:
        texte = "Выбирайте, что хотели бы купить.";
        break;
    case 132:
    ...
    case 155:
        ...
        break;
    case 156:
        texte = "У меня больше нет призов для розыгрыша, извините.";
        break;
    case 157:
    ...
    case 167:
        ...
        break;
    case 168:
        texte = "Сила вашего меча увеличилась втрое, а также вы сможете нанести какую-нибудь магическую атаку, это очень здорово!!!";
        break;
    case 169:
    ...
    case 170:
        ...
        break;
    case 171:
        texte = "Сила ваших перчаток теперь позволяет поднимать тяжелые камни.";
        break;
    case 172:
    ...
    case 177:
        ...
        break;
    case 178:
        texte = "Наша деревня была основана здесь, дабы не допускать беспечных искателей приключений к храму. Я никого не пропущу.";
        break;
    case 179:
