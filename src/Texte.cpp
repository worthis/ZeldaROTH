...
void Texte::chercheText()
{
    ...
    case 28:
        ...
        break;
    case 29:
        texte = "Извини, но твоих рупий недостаточно для этого.";
        break;
    case 30:
    ...
    case 177:
        ...
        break;
    case 178:
        texte = "Наша деревня была образована здесь, дабы не допускать беспечных искателей приключений к храму. Я никого не пропущу.";
        break;
    case 179:
